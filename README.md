...
step3 accepts a custom query as a command-line argument, so you can try
audience-suggested queries live instead of editing the file:
...
argument falls back to the default database-performance query.
